...
public class Matrix_Multiplication {
    ...
    static void matrixMultiplication(int[][] A, int[][] B, int r1, int c2, int r2){
        int[][] C = new int[r1][c2];
        for (int i = 0; i < r1; i++){
            for (int j = 0; j < c2; j++){
                for (int k = 0; k < r2; k++){
    ...
    public static void main(String[] args) {
        ...
        r1 = sc.nextInt();
        c1 = sc.nextInt();
        System.out.print("Input Rows and Columns for Matrix_B : ");
        r2 = sc.nextInt();
        c2 = sc.nextInt();
        ...
        if( c1 == r2) {
            ...
            matrixMultiplication(A, B, r1, c2, r2);
